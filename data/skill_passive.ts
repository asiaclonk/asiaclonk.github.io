...
import { FixedValueSelfCombatPassive } from "./skill_template.js";

export class Data_PassiveSkill {
    /** Basic 2 block passive */
    static ID_0000_FlimsyArmor = new PassiveSkill(0, new FixedValueSelfCombatPassive(2, ResultType.Block), "Flimsy armor", "Block 2 damage every turn.", 0, -1);
