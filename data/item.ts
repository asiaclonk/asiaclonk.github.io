...
export class Item extends DataTemplate {
    /** The rarity description of this item. */
    RarityText: string;
    /** The category description of this item. */
    CategoryText: string;
    ...
    Strength: number;
    /** The number of stacks that can be held in an inventory slot. 1 or higher. */
    StackLimit: number;
    /** The number of inventory slots that can be taken by this item. 0 means no limit. */
    SlotLimit: number;
     ...
     * @param stackLimit The number of stacks that can be held in an inventory slot.
     * @param slotLimit The number of inventory slots that can be taken by this item.
     ...
     */
    constructor (id: number, name?: string, description?: string, lore?: string, icon?: string, rarityText?: string, categoryText?: string, global?: boolean, sellable?: boolean, usable?: boolean, defaultBuyValue?: number, defaultSellValue?: number, stackLimit?: number, slotLimit?: number, activeSkills?: ActiveSkill[], passiveSkills?: PassiveSkill[]) {
        ...
        this.DefaultBuyValue = defaultBuyValue ?? 10;
        this.DefaultSellValue = defaultSellValue ?? 10;
        this.StackLimit = stackLimit ?? 1;
        this.SlotLimit = slotLimit ?? 0;
